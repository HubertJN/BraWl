      ...
      do while (wl_f > tolerance)
        ...
        if (first_reset .eqv. .False. .and. minval(mpi_wl_hist, MASK=(mpi_wl_hist > min_val)) > 100) then ! First reset after system had time to explore
          ...
          if (flatness > flatness_tolerance) then
            ...
            wl_logdos = wl_logdos - wl_logdos_min
            ...
            do i=1, num_windows
                if (mpi_index == i) then
                  if (my_rank /= (i-1)*num_walkers) then
                    ...
                    !print*, my_rank, "Sent to 1", (i-1)*num_walkers
                  end if
                  ...
                  if (my_rank == (i-1)*num_walkers) then
                    do j=1, num_walkers-1
                      ...
                      !print*, my_rank, "Recieving from 1", (i-1)*num_walkers+j
                      !print*, my_rank, wl_logdos
